...
export const ModulePage: React.FC = () => {
  ...
  const handleCompleteModule = async () => {
    ...
    try {
      // --- LÓGICA DE ATUALIZAÇÃO ÚNICA E ROBUSTA ---

      // ETAPA 1: Calcular todos os novos dados ANTES de salvar qualquer coisa.
      ...
      for (const ach of achievementsToCheck) {
        ...
        // A verificação de nível usa o nível ATUAL do usuário
      ...
      // ETAPA 2: Salvar as novas conquistas (se houver)
      ...
      // ETAPA 3: Calcular os pontos e nível FINAIS e fazer uma ÚNICA atualização no perfil.
      const finalTotalPoints = basePoints + bonusPoints;
      const finalLevel = Math.floor(finalTotalPoints / 500) + 1;
      ...
      // ETAPA 4: Atualizar a interface do usuário com todos os dados novos
      await refreshUser();
